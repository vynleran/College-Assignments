######################################################################
# Name: Parsa Jahanlou
# Date: Due June 29th, 2020
# Description: Binary Addiction
######################################################################
...
def fullAdder(Cin, A, B):
	###########################
        # First half adder calculating S0 and C0
	S0 = A ^ B
	C0 = A & B
        # Second half adder calculating S and C1
	S = Cin ^ S0
	C1 = Cin & S0
	# Using C0 and C1 to get Cout
	Cout = C0 | C1
	###########################
